...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="./admin.html"><span class="fa fa-list fa-lg"></span>
                        Admin</a></li>
    ...
    <div class="container">
        <div class="row">
            <ol class="col-12 breadcrumb">
                ...
                <li class="breadcrumb-item active">Flight Info</li>
            </ol>
            <div class="col-12">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            $sql = "SELECT * FROM flightDetails  ORDER BY FlightRegNo";
